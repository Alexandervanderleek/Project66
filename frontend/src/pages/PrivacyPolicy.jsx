...
function PrivacyPolicy() {
  return (
    <div className="flex flex-col justify-between items-center min-h-screen">
      <div className="flex justify-start items-start w-full md:w-3/4 xl:w-1/2 flex-col mb-2">
        <div className="flex w-full justify-between items-end font-bold my-4 text-sm sm:text-xl md:text-2xl ">
        ...
        <ul className="mb-2">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to HabbitFor66.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to HabbitFor66, accessible from{" "}
              <a
                href="https://habbit-66-eb1e4c69dc9a.herokuapp.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://habbit-66-eb1e4c69dc9a.herokuapp.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: alexandervanderleek@gmail.com</li>
        </ul>
      </div>
